---
title: "Hosted Pipeline Integration"
description: "Use the LemonSlice API to connect to your agent via a Daily.co room on any webpage."
---

## Starter App

Find a working example on how to use the hosted pipeline in our [LemonSlice Examples GitHub Repo](https://github.com/lemonsliceai/lemonslice-examples/tree/main/realtime-agent#lemonslice-realtime-agent).
...
Retrieve your API Key from the LemonSlice [dashboard](https://lemonslice.com/agents/api).
...
<Columns cols={3}>
  <Card title="LemonSlice Room API Documentation" icon="book-open" href="https://lemonslice.com/docs/api-reference/create-room" cta="Reference for LemonSlice Room API."></Card>
  <Card title="Daily Documentation" icon="book-open" href="https://docs.daily.co" cta="Reference for the Daily platform."></Card>
  <Card title="LemonSlice Daily Example" icon="hammer" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/realtime-agent#lemonslice-realtime-agent" cta="Ready-to-use example to connect to a LemonSlice Agent."></Card>
</Columns>