...
The following resources provide more information about using LemonSlice with Daily.

<Columns cols={3}>
  <Card title="LemonSlice Room API Documentation" icon="book-open" href="/api-reference/create-room" cta="View docs"></Card>
  <Card title="Daily Documentation" icon="book-open" href="https://docs.daily.co" cta="View docs"></Card>
  <Card title="Ready-to-use LemonSlice Daily Example" icon="code" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/realtime-agent#lemonslice-realtime-agent" cta="View example"></Card>
</Columns>