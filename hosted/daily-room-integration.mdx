...
<Columns cols={3}>
  ...
  <Card title="Ready-to-use LemonSlice Daily Example" icon="hammer" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/realtime-agent#lemonslice-realtime-agent" cta="View example"></Card>
</Columns>