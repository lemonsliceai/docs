...
Find a working example on how to use the hosted pipelnie in our [LemonSlice Examples Github Repo](https://github.com/lemonsliceai/lemonslice-examples/tree/main/realtime-agent#lemonslice-realtime-agent).
...
Use the `POST /liveai/rooms` endpoint to create a Daily room configured with a LemonSlice agent. The agent will automatically join the room once it's startup is complete.
