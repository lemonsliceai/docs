...
Add the widget to any webpage with a single HTML tag in your header. Replace `agent_id` with your agent managed through the [LemonSlice Agent Dashboard](https://lemonslice.com/agents).
