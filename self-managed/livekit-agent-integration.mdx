...
```
  ...
  <Note>When using the [**Gemini Live S2S**](https://docs.livekit.io/agents/models/realtime/plugins/gemini/) model for realtime interactions, set `response_done_timeout=0.5` to handle end of responses correctly.
  
  If you encounter stutters or glitches with any other TTS, please contact support@lemonslice.com.</Note>
