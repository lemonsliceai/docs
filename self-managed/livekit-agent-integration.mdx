...
<Columns cols={2}>
  <Card title="LemonSlice Session API Documentation" icon="book-open" href="/api-reference/create-session" cta="View docs"></Card>
  <Card title="LiveKit Documentation" icon="book-open" href="https://docs.livekit.io/intro/overview/" cta="View docs"></Card>
  <Card title="Ready-to-use LemonSlice LiveKit Example Agent" icon="hammer" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/livekit-lemonslice-agent" cta="View example"></Card>
