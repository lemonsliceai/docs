...
<a href="https://lemonslice.com/promo" style={{ display: 'inline-block', padding: '10px 20px', border: '1px solid currentColor', textDecoration: 'none', borderRadius: '5px' }}>Get 1 month free</a>
