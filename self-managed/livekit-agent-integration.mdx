...
<Columns cols={2}>
  <Card title="Ready-to-use LemonSlice LiveKit Example Agent" icon="code" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/livekit-lemonslice-agent" cta="View example"></Card>
