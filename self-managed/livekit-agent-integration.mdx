...
<a href="https://lemonslice.com/promo" className="button" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#4CAF50', color: 'white', textDecoration: 'none', borderRadius: '5px', fontWeight: 'bold', marginBottom: '20px' }}>Get 1 month free</a>
