...
<a href="https://lemonslice.com/promo" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: 'var(--ifm-color-primary, #000)', color: '#fff', textDecoration: 'none', borderRadius: '5px' }}>Get 1 month free</a>
