...
<Columns cols={2}>
  ...
  <Card title="LemonSlice Livekit Example Agent" icon="hammer" href="https://github.com/lemonsliceai/lemonslice-examples/tree/main/livekit-lemonslice-agent" cta="Ready-to-use LiveKit agent with avatar support using LemonSlice."></Card>
